    ...
    >
      <div className="flex justify-between p-5 ld:flex lg:justify-between lg:items-center lg:px-10 xl:max-w-6xl xl:px-0 xl:mx-auto">
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          >
            <ListItemCard>Projects</ListItemCard>
            <ListItemCard>Services</ListItemCard>
            <ListItemCard>About Us</ListItemCard>
            <ListItemCard>Careers</ListItemCard>
            <ListItemCard>Blog</ListItemCard>
          </ul>
